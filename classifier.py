...
from keras.layers import Activation, Add, Input, Conv1D, Flatten, Dense, AvgPool1D, MaxPool1D, Concatenate, BatchNormalization
...
def build_single_instinct_model(input_shape, file_path, depth, use_residual, num_classes, kernel_sizes, stride=1, 
							    ...
							    global_pool=False, number_of_filters=8):
