...
def generate_representation(labels_df, data_df):
    ...
    rep1d, generation_time = generate_1d_representation(num_entities, num_timestamps, num_symbols, 
                                                        entities_idx, symbols_idx, 
                                                        data_df)
