...
RGT_N_SAMPLES_ARRAY = [10, 50, 100, 200, 300, 400, 500, 600, 800, 1000]
...
TT_N_SAMPLES_ARRAY = [10, 50, 100, 200, 300, 400, 500, 600, 800, 1000]
...
# TT by Number of entities large configuration 

TT_N_SAMPLES_LARGE_ARRAY = [100, 1000, 2500, 5000, 7500, 10000]

ENTITIES_NUM_LARGE_CODE = 4
...
tt_data_sampling_dict = {
    ...
    ENTITIES_NUM_LARGE_CODE: {
        'description': ENTITIES_NUM,
        'values': TT_N_SAMPLES_LARGE_ARRAY, 
        'sampling_function': get_n_entities_of_labels_and_data,
        'preprocess_function': None,  # get_stis_series_until_specified_len_of_labels_and_data,
        'preprocess_args': None  # {'len_stis_series': 64}
    }
}